...
namespace SoftGL
{
    ...
    public:
        ...
        inline void setWrapMode(int mode) 
        {
            wrapMode_ = (WrapMode)mode;
        }

        inline void setFilterMode(int mode)
        {
            filterMode_ = (FilterMode)mode;
        }
    ...
    template<typename T>
    T BaseSampler<T>::textureImpl(TextureImageSoft<T> *tex, glm::vec2 &uv, float lod, glm::ivec2 offset)
    {
    ...
    public:
        ...
        T textureCubeLodImpl(glm::vec3 &coord, float lod = 0.f)
        {
            ...
            TextureImageSoft<T> *tex = tex_[index];
    ...
    private:
        // +x, -x, +y, -y, +z, -z
        TextureImageSoft<T> *tex_[6] = {nullptr, nullptr, nullptr, nullptr, nullptr, nullptr};
    };
    ...
    {
    public:
        TextureType texType() override { return TextureType_2D; }
        ...
        inline TextureSoft<T> *getTexture() { return tex_; }
    ...
    {
    public:
        TextureType texType() override { return TextureType_CUBE; }
