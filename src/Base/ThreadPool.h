...
namespace SoftGL
{
    ...
    {
    public:
        explicit ThreadPool(const size_t threadCnt = std::thread::hardware_concurrency()) : threadCnt_(threadCnt), threads_(new std::thread[threadCnt])
        {
            createThreads();
        }
